<template>
    <div class="development">
        <div class="container-1">
            <MainBanner>
                <template v-slot:header-1>Simplified Development Process.</template>
        ...
        <div class="container-2">
            ...
            <div class="img-container">
                <img src="../assets/images/development/software_dev_ls.png" alt="">
            </div>
        </div>
        <div class="container-3 container-xl">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 card">
                    <Card>
                        <template v-slot:title-main>Ideal Startup</template>
                        <template v-slot:title-sub>Starting up on your first website for your buisness or idea? Are you
                ...
                <div class="col-lg-6 col-md-6 card">
                    <Card>
                        ...
                        <template v-slot:title-sub>Setting up your website for your business or idea? or just want us
                            toredesign and optimize it for you?</template>
                        <template v-slot:content>WordPress contains plugin architecture and a template system, so you
                            ...
                            building it could be overwhelming and you might not optimize it for your benifit. Our
                            experienced developers in the space can help you build the best vertion of the website
                ...
                <div class="col-lg-6 col-md-6 card">
                    <Card>
                        ...
                        <template v-slot:title-sub>Setting up your website for your business or idea? or just want us to
                            redesign and optimize it for you?</template>
                        <template v-slot:content>Our experience lies in the design and creation of Web-based systems to
                            ...
                            years of experience in the world of web apps gives us the edge to figure out where you re
                ...
                <div class="col-lg-6 col-md-6 card">
                    <Card>
                        ...
                        <template v-slot:content>We are a complete supplier of retail applications and hardware systems
                            ...
                            application vs being a Cloud based application. Click for more info.</template>
                        <template v-slot:img>
                            <img src="" alt="">
                        </template>
                    </Card>
                ...
                <div class="col-lg-6 col-md-6 card">
                    <Card>
                        <template v-slot:title-main>Desktop Aplications</template>
                ...
                <div class="col-lg-6 col-md-6 card">
                    <Card>
                        <template v-slot:title-main>App Development</template>
                        <template v-slot:title-sub>Create a custom coded website tailored just for you. Engagement -
                            lead generation focused.</template>
