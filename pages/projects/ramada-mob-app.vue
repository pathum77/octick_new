        ...
        <div class="bottom">
            ...
            <div class="row">
                <div class="tab-view-box col-lg col-md">
                    <div class="frame">
                        <div class="screen">
                            <video src="../../assets/images/clients/ramada_vid.mp4" autoplay muted loop>Your browser does not support video tag</video>
                        </div>
                    </div>
