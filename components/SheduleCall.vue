            ...
            <div v-if="scheduleCallBoxIsVisible" class="schedule-call-box">
                ...
                <div class="left-right row">
                    ...
                    <transition name="form-btn-trans">
                        <button @click="formBackBtn()" v-if="formIsVisible" class="btn-form-back"><img style="width: 30px;" src="../assets/icons/arrow-left-circle.svg" alt=""></button>
                    </transition>
                    ...
                    <div class="horizontal-vertical" style="width: 1px; height: 360px; padding: 0; background-color: grey;"></div>
                    <div v-if="rightBoxIsVisible" class="right-box col">
                        ...
                        <!-- current month -->
                            ...
                            <div class="cal-top">
                                ...
                                <div style="display: flex;">
                                    <button @click="currentMonthIsVisible = true; nextMonthIsVisible = false;" class="cal-top-month-btn"><img style="width: 10px;" src="../assets/icons/prev.png" alt=""></button>
                                    <button @click="nextMonthIsVisible = true; currentMonthIsVisible = false;" class="cal-top-month-btn"><img style="width: 10px;" src="../assets/icons/next_red.png" alt=""></button>
                                </div>
                            </div><br>
                            <div class="cal-weeks">
                                <p>MON</p>
                            ...
                            <div class="cal-days">
                                <div v-for="(date, index) in dates" :key="index" class="cal-date-box">
                                    <button @click="dateSelected(index)" :class="workDay[index+1] ? 'btn-cal-date-box-workday' : 'btn-cal-date-box-holiday'" :id="currentMonthBtnSelectedBG[index] ? 'btn-cal-selected' : 'dsfs'">{{date}}</button>
                                </div>
                            </div>
                        </div>
                            <!-- next month -->
                        <div v-if="nextMonthIsVisible" class="calender-box">
                            <div class="cal-top">
                                ...
                                <div style="display: flex;">
                                    <button @click="currentMonthIsVisible = true; nextMonthIsVisible = false;" class="cal-top-month-btn"><img style="width: 10px;" src="../assets/icons/prev_red.png" alt=""></button>
                                    <button @click="nextMonthIsVisible = true; currentMonthIsVisible = false;" class="cal-top-month-btn"><img style="width: 10px;" src="../assets/icons/next.png" alt=""></button>
                                </div>
                            </div><br>
                            <div class="cal-weeks">
                                <p>MON</p>
                            ...
                            <div class="cal-days">
                                <div v-for="(nextMonthDate, index) in nextMonthDates" :key="index" class="cal-date-box">
                                    <button @click="dateSelected(index)" :class="nextMonthWorkDay[index+1] ? 'btn-cal-date-box-workday' : 'btn-cal-date-box-holiday'" :id="nextMonthBtnSelectedBG[index] ? 'btn-cal-selected' : 'dsfs'">{{nextMonthDate}}</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <transition name="form-trans">
                        <div v-if="formIsVisible" class="form-container col-lg col-md">
                            <form>
                                ...
                                <label class="label-bold" for="">Which of these bests describes what you're hoping to achieve working with us. *</label><br>
                                <input v-model="formFact" class="form-check-input" type="radio" name="fact" id="" value="To build software product">
                                <label class="label-regular" for="">&nbsp; I want to build my software product</label><br>
                                <input v-model="formFact" class="form-check-input" type="radio" name="fact" id="" value="To increase engineering bandwidth" required>
                                <label class="label-regular" for="">&nbsp; I want to increase engineering bandwidth</label><br>
                                <input v-model="formFact" class="form-check-input" type="radio" name="fact" id="" value="To take product to market">
                                <label class="label-regular" for="">&nbsp; I want to take my product to market</label><br>
                                <input v-model="formFact" class="form-check-input" type="radio" name="fact" id="" value="To generate more leads/customers">
                                <label class="label-regular" for="">&nbsp; I need to generate more leads/customers</label>
                                <br><br>
                                <label class="label-bold" for="">Tell us a little bit about what you need *</label>
                                <textarea v-model="formDesc" class="form-controll" name="" id="" cols="50" rows="3" required></textarea><br>
                                <label class="label-bold" for="">Company Website *</label>
                                <input v-model="formCompSite" class="form-control" type="text" name="" id="" required><br>
                                ...
                                <button type="button" @click="scheduleCallBtn()" class="btn-form-container">Schedule Event</button><br><br>
                            </form>
                        </div>
                    </transition>
                        ...
                        <div v-if="timeRangeIsVisible" class="time-box col-lg-3 col-md-3 col-sm-3">
                            ...
                            <div class="row">
                                <div class="time-range-box col-lg col-md col-sm">
                                    <button @click="timeSelectedConfirmation(timeIndex)" v-for="(time, timeIndex) in times" :key="timeIndex">{{time}}</button>
                                </div>
                            </div>
                        </div>
                    </transition>
